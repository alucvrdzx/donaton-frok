...
const UsuariosPage = () => {
  ...
  const fetchUsuarios = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch('https://option-laden-investigator-careful.trycloudflare.com/api/usuarios', {
  ...
  const cambiarRol = async (id, nuevoRol) => {
    ...
    const token = localStorage.getItem('token');
    try {
      const response = await fetch(`https://option-laden-investigator-careful.trycloudflare.com/api/usuarios/${id}/rol`, {
        method: 'PUT',
        headers: { 
  ...
  const eliminarUsuario = async (id) => {
    ...
    const token = localStorage.getItem('token');
    try {
      const response = await fetch(`https://option-laden-investigator-careful.trycloudflare.com/api/usuarios/${id}`, {
        method: 'DELETE',
        headers: { 'Authorization': `Bearer ${token}` }
      });
